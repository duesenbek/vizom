...
export interface ChartType {
  ...
  name: string;
  icon: string;
  category: 'comparison' | 'trend' | 'composition' | 'correlation' | 'distribution' | 'matrix' | 'kpi' | 'temporal' | 'flow' | 'hierarchy' | 'network';
  description: string;
...
export const DEFAULT_ANIMATION: ChartAnimation = {
  enabled: true,
  duration: 750,
