...
class EnvConfig {
  ...
  private customValidation(key: string, value: any, schema: any): void {
    switch (key) {
  ...
  public getServerConfig(): Record<string, any> {
...
export const getEnv = (key: string) => envConfig.get(key);
...
// Export types
export type EnvConfigType = ReturnType<typeof getAllEnv>;
export type ClientEnvType = ReturnType<typeof getClientEnv>;
export type ServerEnvType = ReturnType<typeof getServerEnv>;
